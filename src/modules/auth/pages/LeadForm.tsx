...
const LeadForm = ({ navigation, route }) => {
  ...
  // const [chequeFileData, setChequeFileData] = useState({
  //   uri: "",
  //   name: "",
  //   type: "",
  // });
  
  // async function getInitialDetail() {
  //   try {
  //     setIsLoading(true);
  //     let newUserData: any = await AsyncStorage.getItem(NEW_USER_DETAILS_CACHE);
  //     let cheque: any = await AsyncStorage.getItem(CHEQUE_FILE_DATA);
  //     if (newUserData) {
  //       newUserData = JSON.parse(newUserData);
  //       setNewUserDetails(newUserData);
  //     }
  //     let banksList: any = await getBanks();
  //     if (banksList?.length > 0) {
  //       banksList = await banksList?.map((ele: any) => ({
  //         label: ele?.bankNameAndBranch,
  //         value: ele?.bankNameAndBranch,
  //         id: ele?.bankId,
  //       }));
  //     } else {
  //       banksList = [];
  //     }
  //     setBankList([{ label: "Select", value: "Select", id: "" }, ...banksList]);

  //     if (cheque) {
  //       cheque = JSON.parse(cheque);
  //       if (cheque) {
  //         setChequeFileData(cheque);
  //       }
  //     }
  //   } catch (e) {
  //   } finally {
  ...
  //     if (label?.includes("bankDetail")) {
  //       if (label === "bankDetail.bankNameAndBranch") {
  //         const tempLabel = label?.replace("bankDetail.", "");
  //         updatedValue = {
  //           ...newUserDetails?.bankDetail,
  //           [tempLabel]: value,
  //           bankId:
  //             bankList?.filter((ele) => ele?.value === value)?.[0]?.id || "",
  //         };
  //         label = "bankDetail";
  //       } else {
  //         const tempLabel = label?.replace("bankDetail.", "");
  ...
  //       }
  //     }
  //     setNewUserDetails((existData: any) => {
  //       return { ...existData, [label]: updatedValue };
  //     });
  //   } catch (e) {}
  // };
  ...
  //       type: type,
  //     };
  //     if (label === t("strings:lbl_upload_cancelled_cheque")) {
  //       setChequeFileData(fileData);
  //     }
  //   } catch (error) {
  ...
  //     if (checked) {
  //       if (
  //         newUserDetails?.bankDetail?.nomineeMobileNo &&
  //         !mobileNoValidation(newUserDetails?.bankDetail?.nomineeMobileNo)
  //       ) {
  //         ToastAndroid.show(t("strings:enter_valid_mobileNo"), ToastAndroid.SHORT);
  //         return;
  //       }

  //       if (
  //         newUserDetails?.bankDetail?.nomineeEmail &&
  //         !mailValidation(newUserDetails?.bankDetail?.nomineeEmail)
  //       ) {
  //         ToastAndroid.show(t("strings:enter_valid_mail"), ToastAndroid.SHORT);
  //         return;
  //       }
  //       if (!checkBankDetailsReq()) {
  //         ToastAndroid.show(
  //           t("strings:please_fill_your_complete_bank_details"),
  //           ToastAndroid.SHORT
  //         );
  //         return;
  //       }

  //       if (!checkNomineeDetailsReq()) {
  //         ToastAndroid.show(
  //           t("strings:please_fill_complete_nominee_details"),
  //           ToastAndroid.SHORT
  //         );
  //         return;
  //       }
  ...
  //         CHEQUE_FILE_DATA,
  //         JSON.stringify(chequeFileData)
  //       );
  //       await AsyncStorage.setItem(
  //         NEW_USER_DETAILS_CACHE,
  //         JSON.stringify(newUserDetails)
  //       );
  //       navigation.navigate("PreviewSummary");
  //     } else {
  //       ToastAndroid.show(
  //         t("strings:please_agree_toterms"),
  //         ToastAndroid.SHORT
  //       );
  //     }
  //   } catch (err) {
  ...
  //   if (
  //     newUserDetails?.bankDetail?.bankAccNo ||
  //     newUserDetails?.bankDetail?.bankAccHolderName ||
  //     chequeFileData?.uri ||
  //     newUserDetails?.bankDetail?.bankIfsc ||
  //     newUserDetails?.bankDetail?.bankAccType ||
  //     newUserDetails?.bankDetail?.bankNameAndBranch
  //   )
  //     if (
  //       newUserDetails?.bankDetail?.bankAccNo &&
  //       newUserDetails?.bankDetail?.bankAccHolderName &&
  ...
  //   if (
  //     newUserDetails?.bankDetail?.nomineeName &&
  //     newUserDetails?.bankDetail?.nomineeDob &&
  //     newUserDetails?.bankDetail?.nomineeMobileNo &&
  //     newUserDetails?.bankDetail?.nomineeAdd &&
  //     newUserDetails?.bankDetail?.nomineeRelation
  //   )
  //     return true;
  //   else return false;
  // };

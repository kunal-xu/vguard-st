            ...
            switch (documentType) {
                case 'SELFIE':
                    ...
                    case 'ID_CARD_FRONT':
                        ...
                        filesToUpload.push( { imageRelated: 'ID_CARD_FRONT', file: newPhoto })
            ...
            <View style={{ flexDirection: 'column', justifyContent: 'space-around', }}>
                ...
                {form2.currentaddressselections == 'select' || form2.currentaddressselections == 'Yes' ? <></> : <>
                   ...
                   <DropDownPicker
                      ...
                      loading={isLoading}
                      label={value}
                      placeholder={form2.currentpincode === null ? 'Search Pincode' : `Searched Pincode:${form2.currentpincode}`}
                ...
                {/* <Text style={{ color: colors.black, marginLeft: 2, marginBottom: 2, fontWeight: 'bold' }}>{t('strings:lbl_update_your_selfie')}</Text> */}
                      ...
                      <Pressable onPress={() => setselfieemodal({ isVisible: !selfieemodal.isVisible, documentType: 'SELFIE' })} style={{ justifyContent: 'space-between', flexDirection: 'row', maxWidth: width * 0.9,marginBottom: 20, borderWidth: 2, borderColor: 'black', borderRadius: 5 }}>
                ...
                <Pressable  style={{ justifyContent: 'space-between', flexDirection: 'row', maxWidth: width * 0.9,marginBottom: 20, borderWidth: 2, borderColor: 'black', borderRadius: 5 }}>
